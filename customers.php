...
<head>
  ...
  <script type="text/javascript">
    ...
    $('body').delegate('#addButton', 'click', function() {
       ...
       $('#wrapper').load('forms/customers/new_customer.php');
       //$('#my_camera').show();
...
//          $('#addButton').show();
    ...
    $('body').delegate('#tncback', 'click', function() {
       ...
       $('#wrapper').load('forms/customers/new_customer.php?firstName='+firstName+'&lastName='+lastName+'&phoneNumber='+phoneNumber);
       //$('#my_camera').show();
